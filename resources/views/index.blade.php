...
<body>
    <!-- navbar -->
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm" style="background-color: rgb(221, 207, 207);">
    <div class="container">
        ...
        <div class="col-10">
            ...
            <div class="card-body p-4">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2">
                    <img src="https://s3.bukalapak.com/img/88556318992/s-463-463/data.jpeg.webp" alt="Mini Notebook" class="img-fluid rounded-3">
                </div>
                <div class="col-md-3 col-lg-3 col-xl-3">
                <p class="lead fw-normal mb-2">Mini Notebook</p>
                <p><span class="text-muted">Color: </span>Pink</p>
                </div>
